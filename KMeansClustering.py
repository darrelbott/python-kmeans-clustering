...
digits = load_digits()
data = scale(digits.data) #scale down features
y = digits.target
...
#completeness - checks if all members of a given class are assigned to the same cluster (ranges from 0-1)
#v_measure - is the harmonic mean of homo. and compl.  (ranges from 0-1)
